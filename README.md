...
> Hands (`helix hands run`), Atlas pins (`helix atlas`), and plot commits
> (`helix plot commit|list|rewind|status`) work today. Plot-scoped file
> adapters and connectors are next.
